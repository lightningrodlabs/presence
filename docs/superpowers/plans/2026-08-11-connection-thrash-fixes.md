...
**Status: Tasks 1-10 landed on `main-0.6` (2026-08-12); Task 11 (forward-port to `main-0.7`) pending.** See `CLAUDE.md`'s "Connection-thrash round facts" bullet for the doc-sync summary.
