// Copied from presence ui/src/room/modules/__tests__/av-sync.test.ts at ab90584 (signals-media extraction). Presence keeps its own copy until the adoption round.
import { describe, it, expect } from 'vitest';
import { estimatePlayoutSenderTimeMs, framePaceMs } from '../av-sync.js';
