// Copied from presence ui/src/transport/__tests__/signals-cadence-policy.test.ts at ab90584 (signals-media extraction). Presence keeps its own copy until the adoption round.
import { describe, expect, it } from 'vitest';
import { decideSignalsMediaCadence, SIGNALS_RTT_DEGRADED_MS, SIGNALS_RTT_COLLAPSED_MS } from '../signals-cadence-policy.js';
