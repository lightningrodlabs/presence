// Copied from presence ui/src/__tests__/voice-admission.test.ts at ab90584 (signals-media extraction). Presence keeps its own copy until the adoption round.
