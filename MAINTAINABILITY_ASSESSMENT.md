...
### Phase 3 — Retire a carrier — **BUILT 2026-07-29, awaiting adversarial review**

Branch `feat/phase-3-retire-carrier` off `main-0.6`, one commit per item, in the strict order below. The suites went 584 → 514 (222 package + 292 ui — a net *decrease*, because item 3 deleted ~80 SimplePeer/auto-flip tests while items 1–2 added ~10); the gate is green. Field validation has not run; per working agreement 9 this section is marked LANDED only after an independent session reviews the diff.
